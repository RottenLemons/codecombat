...
const ChatView = require('./LevelChatView'); // TODO: Consider removing.
...
module.exports = (PlayLevelView = (function() {
  PlayLevelView = class PlayLevelView extends RootView {
    ...
    onWorldNecessitiesLoaded() {
      ...
      this.setMeta({
        title: $.i18n.t('play.level_title', { level: this.level.get('name') })
      });
    ...
    updateSpellPalette(thang, spell) {
      ...
      if (this.spellPaletteView) { this.removeSubview(this.spellPaletteView); }
