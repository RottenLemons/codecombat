...
module.exports = (PollModal = (function() {
  PollModal = class PollModal extends ModalView {
    ...
    updateAnswers(answered) {
      ...
      for (answer of Array.from(this.poll.get('answers'))) {
        var $answer = this.$el.find(`.answer[data-answer='${answer.key}']`);
        ...
        var widthPercentage = ((100 * votes) / maxVotes) + '%';
        var votePercentage = Math.round((100 * votes) / totalVotes) + '%';
    ...
    onClickAnswer(e) {
      ...
      return this.userPollsRecord.save({polls: pollVotes}, {success: () => {
        let left1;
