  ...
  I18NHomeView = class I18NHomeView extends RootView {
    ...
    constructor(options) {
      ...
      if (utils.isOzaria) {
        ...
        collections = [this.thangTypes, this.components, this.levels, this.achievements, this.campaigns, this.polls, this.courses, this.articles, this.resourceHubResource];
      }
