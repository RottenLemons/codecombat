...
describe('TeacherCoursesView', function() {
  ...
  return describe('Play Level form', function() {
    ...
    // Not used in Ozaria
    xit('opens HeroSelectModal for the first level of the first course', function(done) {
    ...
    // Not used in Ozaria
    xit("doesn't open HeroSelectModal for other levels", function() {
    ...
    // Not used in Ozaria
    xit("doesn't open HeroSelectModal for other courses", function() {
      spyOn(view, 'openModalView');
      spyOn(application.router, 'navigate');
